...
create table Binary_Tab (BINARY_VAL LONGVARBINARY NULL) ;

drop table Varbinary_Tab ;
create table Varbinary_Tab (VARBINARY_VAL LONGVARBINARY NULL) ;

drop table Longvarbinary_Tab ;
create table Longvarbinary_Tab (LONGVARBINARY_VAL LONGVARBINARY NULL) ;
