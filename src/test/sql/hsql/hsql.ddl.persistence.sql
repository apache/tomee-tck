...
CREATE TABLE CREDITCARD_TABLE(id VARCHAR(255) PRIMARY KEY, TYPE VARCHAR(255), EXPIRES VARCHAR(255), APPROVED NUMERIC, CREDITCARD_NUMBER VARCHAR(255), balance DOUBLE, FK3_FOR_CUSTOMER_TABLE VARCHAR(255), FK_FOR_ORDER_TABLE VARCHAR(255));

DROP table ORDER_TABLE cascade;
CREATE TABLE ORDER_TABLE (id VARCHAR(255) PRIMARY KEY, TOTALPRICE DOUBLE , FK4_FOR_CUSTOMER_TABLE VARCHAR(255), FK0_FOR_LINEITEM_TABLE VARCHAR(255));
...
CREATE TABLE PRODUCT_TABLE (ID VARCHAR(255) NOT NULL, NAME VARCHAR(255), PRICE DOUBLE, QUANTITY INTEGER, PNUM BIGINT, PRODUCT_TYPE VARCHAR(255), INCEPTION DATE, SOLD DATE, MODEL INTEGER, REV DOUBLE, constraint PK_PRODUCT_TABLE PRIMARY KEY(ID));

DROP TABLE PRICED_PRODUCT_TABLE cascade;
CREATE TABLE PRICED_PRODUCT_TABLE (ID VARCHAR(255) NOT NULL, NAME VARCHAR(255), PRICE DOUBLE, QUANTITY INTEGER, PNUM BIGINT , constraint PK_PRICED_PRODUCT_TABLE PRIMARY KEY(ID));
...
CREATE TABLE BEANEJB_1X1_BI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL, FK1_FOR_AEJB_1X1_BI_BTOB VARCHAR(255), FK2_FOR_AEJB_1X1_BI_BTOB VARCHAR(255), FK1_FOR_BEJB_1X1_BI_BTOB VARCHAR(255), FK2_FOR_BEJB_1X1_BI_BTOB VARCHAR(255));

DROP table AEJB_1X1_BI_BTOB cascade;
CREATE TABLE AEJB_1X1_BI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_1X1_BI_BTOB cascade;
CREATE TABLE BEJB_1X1_BI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_1X1_BI_BTOB VARCHAR(255));
...
CREATE TABLE BEANEJB_1X1_BI_CASCADE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL, FK1_FOR_AEJB_1X1_BI_CASCADE VARCHAR(255), FK2_FOR_AEJB_1X1_BI_CASCADE VARCHAR(255), FK1_FOR_BEJB_1X1_BI_CASCADE VARCHAR(255), FK2_FOR_BEJB_1X1_BI_CASCADE VARCHAR(255));

DROP table AEJB_1X1_BI_CASCADE cascade;
CREATE TABLE AEJB_1X1_BI_CASCADE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_1X1_BI_CASCADE cascade;
CREATE TABLE BEJB_1X1_BI_CASCADE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_1X1_BI_CASCADE VARCHAR(255));
...
CREATE TABLE BEANEJB_1XM_BI_DELETE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL, FK1_FOR_AEJB_1XM_BI_DELETE VARCHAR(255), FK2_FOR_AEJB_1XM_BI_DELETE VARCHAR(255), FK1_FOR_BEJB_1XM_BI_DELETE VARCHAR(255), FK2_FOR_BEJB_1XM_BI_DELETE VARCHAR(255));

DROP table AEJB_1XM_BI_DELETE cascade;
CREATE TABLE AEJB_1XM_BI_DELETE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_1XM_BI_DELETE cascade;
CREATE TABLE BEJB_1XM_BI_DELETE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_1XM_BI_DELETE VARCHAR(255));
...
CREATE TABLE BEANEJB_1XM_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL, FK1_FOR_AEJB_1XM_UNI_BTOB VARCHAR(255), FK2_FOR_AEJB_1XM_UNI_BTOB VARCHAR(255), FK1_FOR_BEJB_1XM_UNI_BTOB VARCHAR(255), FK2_FOR_BEJB_1XM_UNI_BTOB VARCHAR(255), FK3_FOR_BEJB_1XM_UNI_BTOB VARCHAR(255), FK4_FOR_BEJB_1XM_UNI_BTOB VARCHAR(255));

DROP table AEJB_1XM_UNI_BTOB cascade;
CREATE TABLE AEJB_1XM_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_1XM_UNI_BTOB cascade;
CREATE TABLE BEJB_1XM_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_1XM_UNI_BTOB VARCHAR(255));
...
CREATE TABLE BEANEJB_MX1_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL, FK1_FOR_AEJB_MX1_UNI_BTOB VARCHAR(255), FK2_FOR_AEJB_MX1_UNI_BTOB VARCHAR(255), FK1_FOR_BEJB_MX1_UNI_BTOB VARCHAR(255), FK2_FOR_BEJB_MX1_UNI_BTOB VARCHAR(255), FK3_FOR_BEJB_MX1_UNI_BTOB VARCHAR(255), FK4_FOR_BEJB_MX1_UNI_BTOB VARCHAR(255));

DROP TABLE AEJB_MX1_UNI_BTOB cascade;
CREATE TABLE AEJB_MX1_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_MX1_UNI_BTOB cascade;
CREATE TABLE BEJB_MX1_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_MX1_UNI_BTOB VARCHAR(255));
...
CREATE TABLE AEJB_MX1_UNI_DELETE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_MX1_UNI_DELETE cascade;
CREATE TABLE BEJB_MX1_UNI_DELETE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_MX1_UNI_DELETE VARCHAR(255));
...
CREATE TABLE AEJB_MXM_BI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_MXM_BI_BTOB cascade;
CREATE TABLE BEJB_MXM_BI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL );
...
CREATE TABLE AEJB_MXM_BI_DELETE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_MXM_BI_DELETE cascade;
CREATE TABLE BEJB_MXM_BI_DELETE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL );
...
CREATE TABLE AEJB_MXM_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_MXM_UNI_BTOB cascade;
CREATE TABLE BEJB_MXM_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL );
...
CREATE TABLE BEANEJB_1X1_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL, FK1_FOR_AEJB_1X1_UNI_BTOB VARCHAR(255), FK2_FOR_AEJB_1X1_UNI_BTOB VARCHAR(255), FK1_FOR_BEJB_1X1_UNI_BTOB VARCHAR(255), FK2_FOR_BEJB_1X1_UNI_BTOB VARCHAR(255));

DROP table AEJB_1X1_UNI_BTOB cascade;
CREATE TABLE AEJB_1X1_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_1X1_UNI_BTOB cascade;
CREATE TABLE BEJB_1X1_UNI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_1X1_UNI_BTOB VARCHAR(255));
...
CREATE TABLE AEJB_1XM_BI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_1XM_BI_BTOB cascade;
CREATE TABLE BEJB_1XM_BI_BTOB ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_1XM_BI_BTOB VARCHAR(255));
...
CREATE TABLE BEANEJB_1XM_BI_CASCADE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL, FK1_FOR_AEJB_1XM_BI_CASCADE VARCHAR(255), FK2_FOR_AEJB_1XM_BI_CASCADE VARCHAR(255), FK1_FOR_BEJB_1XM_BI_CASCADE VARCHAR(255), FK2_FOR_BEJB_1XM_BI_CASCADE VARCHAR(255));

DROP table AEJB_1XM_BI_CASCADE cascade;
CREATE TABLE AEJB_1XM_BI_CASCADE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255) , value NUMERIC NOT NULL);

DROP table BEJB_1XM_BI_CASCADE cascade;
CREATE TABLE BEJB_1XM_BI_CASCADE ( id VARCHAR(255) PRIMARY KEY, name VARCHAR(255), value NUMERIC NOT NULL, FK_FOR_AEJB_1XM_BI_CASCADE VARCHAR(255));
...
CREATE TABLE EMPLOYEE (ID INTEGER NOT NULL, FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), HIREDATE DATE, SALARY REAL NOT NULL, STATUS VARCHAR(255), FK_MGR INTEGER, FK_DEPT INTEGER, FK_PROJECT INTEGER, FK_INS INTEGER, constraint PK_EMPLOYEE PRIMARY KEY(ID));

DROP TABLE DEPARTMENT cascade;
CREATE TABLE DEPARTMENT (NAME VARCHAR(255), ID INTEGER NOT NULL, COMPANY_COMPANYID INTEGER , constraint PK_DEPARTMENT PRIMARY KEY(ID));
...
CREATE TABLE TEAM (NAME VARCHAR(255) NOT NULL, TEAMID INTEGER NOT NULL, COMPANY_COMPANYID INTEGER, constraint PK_TEAM PRIMARY KEY(TEAMID));
...
CREATE TABLE PROJECT (PROJID INTEGER NOT NULL, NAME VARCHAR(25), BUDGET DECIMAL(18, 0), constraint PK_PROJECT PRIMARY KEY(PROJID));
...
CREATE TABLE DATATYPES (BOOLEANDATA SMALLINT, CHARDATA CHAR, SHORTDATA SMALLINT, INTDATA INTEGER, LONGDATA BIGINT, DBLDATA DOUBLE, FLOATDATA FLOAT, ID INTEGER NOT NULL, ENUMODATA INTEGER, ENUMSDATA VARCHAR(25), BYTEDATA SMALLINT, constraint PK_DATATYPES PRIMARY KEY(ID));

DROP TABLE DATATYPES2 cascade;
CREATE TABLE DATATYPES2 (DATATYPES2_ID TIMESTAMP NOT NULL, TIMEDATA TIMESTAMP, TSDATA TIMESTAMP, BYTEDATA LONGVARBINARY, CHARDATA VARCHAR(448), constraint PK_DATATYPES2 PRIMARY KEY(DATATYPES2_ID));

DROP TABLE GENERATOR_TABLE cascade ;
CREATE TABLE GENERATOR_TABLE (PK_COL VARCHAR(10) NOT NULL, VAL_COL INTEGER , constraint PK_GENERATOR_TABLE PRIMARY KEY(PK_COL));
INSERT into GENERATOR_TABLE(PK_COL, VAL_COL) values ('DT_ID', 1) ;

DROP TABLE SEQUENCE;
CREATE TABLE SEQUENCE (SEQ_NAME VARCHAR(10) NOT NULL, SEQ_COUNT INTEGER , constraint PK_SEQUENCE PRIMARY KEY(SEQ_NAME));
INSERT into SEQUENCE(SEQ_NAME, SEQ_COUNT) values ('SEQ_GEN', 0) ;

DROP TABLE PURCHASE_ORDER cascade;
CREATE TABLE PURCHASE_ORDER (ID INTEGER NOT NULL, TOTAL INTEGER, constraint PK_PURCHASE_ORDER PRIMARY KEY(ID));
...
CREATE TABLE MEMBER (MEMBER_ID INTEGER NOT NULL PRIMARY KEY, MEMBER_NAME VARCHAR(255), DUES SMALLINT NULL, VERSION INTEGER, DONATION NUMERIC) ;
