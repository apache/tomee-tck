...
CREATE TABLE DATATYPES ( BOOLEANDATA SMALLINT, CHARDATA INTEGER, SHORTDATA SMALLINT, INTDATA INT, LONGDATA BIGINT, DBLDATA DOUBLE, FLOATDATA FLOAT, ID INT NOT NULL, ENUMODATA INT, ENUMSDATA VARCHAR(25), BYTEDATA SMALLINT, CONSTRAINT PK_DATATYPES PRIMARY KEY (ID));
