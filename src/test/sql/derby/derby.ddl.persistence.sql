...
---CREATE TABLE DATATYPES ( SMALLINTDATA BOOLEAN, CHARDATA CHAR, SHORTDATA SMALLINT, INTDATA INT, LONGDATA BIGINT, DBLDATA DOUBLE, FLOATDATA FLOAT, ID INT NOT NULL, ENUMODATA INT, ENUMSDATA VARCHAR(25), BYTEDATA SMALLINT, CONSTRAINT PK_DATATYPES PRIMARY KEY (ID));
CREATE TABLE DATATYPES ( SMALLINTDATA BOOLEAN, CHARDATA CHAR, SHORTDATA SMALLINT, INTDATA INT, LONGDATA BIGINT, DBLDATA DOUBLE, FLOATDATA FLOAT, ID INT NOT NULL, ENUMODATA INT, ENUMSDATA VARCHAR(25), BYTEDATA SMALLINT, CONSTRAINT PK_DATATYPES PRIMARY KEY (ID));
