 ...
 */
package org.apache.tomee.tck.standalone.concurrency;
 ...
 * {@code bean-discovery-mode="annotated"} to Concurrency TCK deployments.
 *
 * <p>OWB (OpenWebBeans) in TomEE does not auto-enable {@code @Priority}
 * interceptors without an explicit beans.xml; the TCK's
 * {@code AsynchronousInterceptor} relies on this to be activated in
 * deployed WARs. Ported from apache/tomee tck/concurrency-standalone.</p>
 */
